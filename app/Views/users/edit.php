						...
						<div class="card-body">
							...
							<form action="<?php echo site_url('users/update/' . $user['id']); ?>" method="post">
								<div class="mb-3">
									...
									<input type="text" class="form-control" id="username" name="username" value="<?php echo old('username', $user['username']); ?>" required>
								</div>
								<div class="mb-3">
									<label for="phone" class="form-label">Phone</label>
									<input type="text" class="form-control" id="phone" name="phone" value="<?php echo old('phone', $user['phone']); ?>" required>
								</div>
								<div class="mb-3">
								...
								<div class="mb-3">
									...
									<select class="form-control" id="role" name="role" required>
										<option value="cashier" <?php echo old('role', $user['role']) === 'cashier' ? 'selected' : ''; ?>>Cashier</option>
								...
								<div class="d-flex justify-content-between">
									...
									<button type="submit" class="btn btn-pharmacy">Update User</button>
								</div>
							</form>
						</div>
					</div>
